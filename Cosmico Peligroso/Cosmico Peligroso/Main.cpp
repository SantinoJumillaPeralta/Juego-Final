...
int main() {
	RenderWindow window(VideoMode(1000, 650), "Cosmico Pelibroso");
	...
	if (!playerTexture.loadFromFile("player.png")) {
		cout << "Cosmico Peligroso/imagenes/player.png" << endl;
	}
	if (!enemieTexture.loadFromFile("enemie.png")) {
		cout << "Cosmico Peligroso/imagenes/enemie.png" << endl;
	}
	if (!bulletTexture.loadFromFile("bullet.png")) {
		cout << "Cosmico Peligroso/imagenes/bullet.png" << endl;
	}
	if (!bloodTexture.loadFromFile("blood.png")) {
		cout << "Cosmico Peligroso/imagenes/blood.png" << endl;
	}
	if (!backgroundTexture.loadFromFile("background.png")) {
		cout << "Cosmico Peligroso/imagenes/background.png" << endl;
	}
